            ...
            <div className="bg-(--grey2) rounded-[24px] p-5">
                <div className="flex items-center justify-between">
                    <div className="flex gap-2">
                        ...
                        <div>
                            <h1 className="text-(--dark1) text-[24px] font-normal">Add Order</h1>
                            <p className="text-(--dark1)">
                                from here you can add new order
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-3 pt-2">
                        <div className="flex gap-3">
                            {currentStep === 1 ? <Link href='/admin/customer'><Button variant="secondary" className='h-13 rounded-[12px] px-5'>Cancel</Button></Link> : <Button
                                type="button"
                                variant="secondary"
                                onClick={prevStep}
                ...
                <section className="mt-5 w-[85%] mx-auto">
                    <AddNewOrderForm setCurrentStep={setCurrentStep} currentStep={currentStep} nextStep={nextStep} prevStep={prevStep} />
                </section>
            </div>
        </CommonLayout>
    )
